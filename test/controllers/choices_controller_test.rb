...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { question_id: @choice.question_id, selected: @choice.selected, statement: @choice.statement }
    end
  ...
  test "should update choice" do
    patch :update, id: @choice, choice: { question_id: @choice.question_id, selected: @choice.selected, statement: @choice.statement }
    assert_redirected_to choice_path(assigns(:choice))
  end
